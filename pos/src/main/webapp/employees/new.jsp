...
<form id="employee_form" accept-charset="utf-8" method="post" action="<s:url action="save"/>">
<s:token/>
...
<div class="field_row clearfix">
	  ...
	  <s:textfield  label="User Name" name="username" required="true" cssClass="required" size="20" maxlength="20" />
