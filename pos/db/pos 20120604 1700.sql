...
INSERT INTO `orders` (`ORDER_ID`,`CUSTOMER_ID`,`EMPLOYEE_ID`,`SHIPPING_AMOUNT`,`TAX_AMOUNT`,`OTHER_AMOUNT`,`DISCOUNT`,`NOTE`,`ORDER_DATE`,`SHIPPING_DATE`,`ORDER_STATUS`) VALUES 
 (100,100,0,'150.00','120.00','1000.00','50.00','testing',NULL,2011,1);
...
INSERT INTO `products` (`ID`,`NAME`,`DESCRIPTION`,`PRODUCT_CATEGORY_ID`,`STATUS`) VALUES 
 (1,'ACC CEMENT 11','CEMENTS',1,0),
 (2,'KC SUPER','CEMENTS',1,0),
 (3,'LAFARGE','Cements',1,0),
 (4,'TATA STEEL 10MM','ROD',2,0),
 (5,'TATA STEEL 12MM','ROD',2,0),
 (6,'LOCAL ROD','ROD',2,0);
